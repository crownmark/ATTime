...
{
    public partial class EditTimeEntryTemplate
    {
        [Inject]
        ...
        {
            timeEntryTemplate = await ATTimeService.GetTimeEntryTemplateByTimeEntryTemplateId(timeEntryTemplateId:TimeEntryTemplateId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await ATTimeService.UpdateTimeEntryTemplate(timeEntryTemplateId:TimeEntryTemplateId, timeEntryTemplate);
