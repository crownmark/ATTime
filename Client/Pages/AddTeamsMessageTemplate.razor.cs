...
{
    public partial class AddTeamsMessageTemplate
    {
        [Inject]
        ...
        {
            teamsMessageTemplate = new CrownATTime.Server.Models.ATTime.TeamsMessageTemplate();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await ATTimeService.CreateTeamsMessageTemplate(teamsMessageTemplate);
