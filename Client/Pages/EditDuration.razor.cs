...
{
    public partial class EditDuration
    {
        [Inject]
        ...
        {
            duration = await ATTimeService.GetDurationByDurationId(durationId:DurationId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await ATTimeService.UpdateDuration(durationId:DurationId, duration);
