...
{
    public partial class EditWorkflowStep
    {
        [Inject]
        ...
        {
            workflowStep = await ATTimeService.GetWorkflowStepByWorkflowStepId(workflowStepId: WorkflowStepId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await ATTimeService.UpdateWorkflowStep(workflowStepId:WorkflowStepId, workflowStep);
