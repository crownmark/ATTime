...
{
    public partial class AddWaitingStatus
    {
        [Inject]
        ...
        {
            waitingStatus = new CrownATTime.Server.Models.ATTime.WaitingStatus();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await ATTimeService.CreateWaitingStatus(waitingStatus);
