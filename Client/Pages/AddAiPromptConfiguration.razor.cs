...
{
    public partial class AddAiPromptConfiguration
    {
        [Inject]
        ...
        {
            aiPromptConfiguration = new CrownATTime.Server.Models.ATTime.AiPromptConfiguration();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await ATTimeService.CreateAiPromptConfiguration(aiPromptConfiguration);
