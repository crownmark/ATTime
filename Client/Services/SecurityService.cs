...
namespace CrownATTime.Client
{
    public partial class SecurityService
    {
        ...
        {
            this.httpClient = factory.CreateClient("CrownATTime.Server");
        ...
        public bool Initialize(AuthenticationState result)
        {
            ...
            var email =
                ...
                Principal.FindFirstValue("email") ??                      // optional claim
                Principal.FindFirstValue("preferred_username") ??         // MOST COMMON for AAD
                Principal.FindFirstValue("upn") ??                        // also common
                Principal.FindFirstValue("unique_name");                  // fallback
