    ...
    public partial class ResourceCachesController : ODataController
    {
        ...
        public IActionResult PutResourceCache(int key, [FromBody]CrownATTime.Server.Models.ATTime.ResourceCache item)
        {
            try
            {
                ...
                Request.QueryString = Request.QueryString.Add("$expand", "CalendarNotificationEventType,AiPromptConfiguration,EmailTemplate,NoteTemplate,TeamsMessageTemplate,TimeEntryTemplate");
